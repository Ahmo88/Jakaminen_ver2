...
$(function () {
    ...
    $("#buttonSendMsg").click(function (e) {
        var dataset = { "valueClient6": document.getElementById('msgFromClient').value };
        $.ajax({
            url: 'message.php',
            type: 'POST',
            data: dataset,
...
setInterval(function (e) {
    $(function () {
        jQuery.get("messages/osaastot/receivemsg6.txt", function (data) {
        ...
        $.ajax({
            url: "messages/osaastot/receivemsg6.txt",
            dataType: "text",
...
$(function () {
    $("#updateButton").click(function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                dir1: "./osaasto6/maanantai/",
                dir2: "./osaasto6/tiistai/",
                dir3: "./osaasto6/keskiviikko/",
                dir4: "./osaasto6/torstai/",
                dir5: "./osaasto6/perjantai/",
                dir6: "./osaasto6/lauantai/",
                dir7: "./osaasto6/sunnuntai/",
        ...
        $('#listBox6 option').each(function () {
            if (this.selected) {
                ...
                $("#btValmis2").click(function (e) {
                    ...
                    var path = "./osaasto6/tiistai/"
                    var selectedFileName = $("#listBox6 option:selected").text();
                    /*
                    var dt = new Date();
                    var time = dt.getHours() + ":" + dt.getMinutes();
                    */
                    // call osaasto6.php and post the data
                    $.ajax({
                        type: "POST",
                        url: "move-images6.php",
                        data: { pathDir: path, name: selectedFileName }
...
$(function () {
    ...
    $("#btDelete3").click(function (e) {
        ...
        if (r5 == true) {
            ...
            var path3 = "./osaasto6/keskiviikko/"
        ...
        if ($(this).is(':checked')) {
         ...
         ////////////////////////////////////////////////////////////////////////
            ...
            function drawCoordinates(x, y) {
                ...
                if ($("#nameFieldCheckBox" ).is(':checked')) {
                //text
                var text = document.getElementById("nameField").value;
                ctx.beginPath();
                context.fillText(text + " " + " " + currentDate + time, x, y);
