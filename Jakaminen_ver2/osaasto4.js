...
$(function () {
    ...
    $("#buttonSendMsg").click(function (e) {
        var dataset = { "valueClient4": document.getElementById('msgFromClient').value };
        $.ajax({
            url: 'message.php',
            type: 'POST',
            data: dataset,
...
setInterval(function (e) {
    $(function () {
        jQuery.get("messages/osaastot/receivemsg4.txt", function (data) {
        ...
        $.ajax({
            url: "messages/osaastot/receivemsg4.txt",
            dataType: "text",
...
$(function () {
    $("#updateButton").click(function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                dir1: "./osaasto4/maanantai/",
                dir2: "./osaasto4/tiistai/",
                dir3: "./osaasto4/keskiviikko/",
                dir4: "./osaasto4/torstai/",
                dir5: "./osaasto4/perjantai/",
                dir6: "./osaasto4/lauantai/",
                dir7: "./osaasto4/sunnuntai/",
        ...
        $('#listBox6 option').each(function () {
            if (this.selected) {
                ...
                $("#btValmis2").click(function (e) {
                    ...
                    var path = "./osaasto4/tiistai/"
                    var selectedFileName = $("#listBox6 option:selected").text();
                    /*
                    var dt = new Date();
                    var time = dt.getHours() + ":" + dt.getMinutes();
                    */
                    // call osaasto4.php and post the data
                    $.ajax({
                        type: "POST",
                        url: "move-images4.php",
                        data: { pathDir: path, name: selectedFileName }
...
$(function () {
    ...
    $("#btDelete3").click(function (e) {
        ...
        if (r5 == true) {
            ...
            var path3 = "./osaasto4/keskiviikko/"
