...
$(function () {
    ...
    $("#nameField").mouseenter(function (e) {
        $("#nameField").val("");
        e.preventDefault();
    });
...
$(function () {
    ...
    $("#buttonSendMsg").click(function (e) {
        var dataset = { "valueClient1": document.getElementById('msgFromClient').value };
        $.ajax({
            url: 'message.php',
            type: 'POST',
            data: dataset,
...
setInterval(function (e) {
    $(function () {
        jQuery.get("messages/osaastot/receivemsg1.txt", function (data) {
        ...
        $.ajax({
            url: "messages/osaastot/receivemsg1.txt",
            dataType: "text",
...
$(function () {
    $("#updateButton").click(function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                dir1: "./osaasto1/maanantai/",
                dir2: "./osaasto1/tiistai/",
                dir3: "./osaasto1/keskiviikko/",
                dir4: "./osaasto1/torstai/",
                dir5: "./osaasto1/perjantai/",
                dir6: "./osaasto1/lauantai/",
                dir7: "./osaasto1/sunnuntai/",
        ...
        $('#listBox6 option').each(function () {
            if (this.selected) {
                ...
                $("#btValmis2").click(function (e) {
                    ...
                    var path = "./osaasto1/tiistai/"
                    var selectedFileName = $("#listBox6 option:selected").text();
                    /*
                    var dt = new Date();
                    var time = dt.getHours() + ":" + dt.getMinutes();
                    */
                    // call osaasto1.php and post the data
                    $.ajax({
                        type: "POST",
                        url: "move-images1.php",
                        data: { pathDir: path, name: selectedFileName }
...
$(function () {
    ...
    $("#btDelete3").click(function (e) {
        ...
        if (r5 == true) {
            ...
            var path3 = "./osaasto1/keskiviikko/"
