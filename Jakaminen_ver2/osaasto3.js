...
$(function () {
    ...
    $("#buttonSendMsg").click(function (e) {
        var dataset = { "valueClient3": document.getElementById('msgFromClient').value };
        $.ajax({
            url: 'message.php',
            type: 'POST',
            data: dataset,
...
setInterval(function (e) {
    $(function () {
        jQuery.get("messages/osaastot/receivemsg3.txt", function (data) {
        ...
        $.ajax({
            url: "messages/osaastot/receivemsg3.txt",
            dataType: "text",
...
$(function () {
    $("#updateButton").click(function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                dir1: "./osaasto3/maanantai/",
                dir2: "./osaasto3/tiistai/",
                dir3: "./osaasto3/keskiviikko/",
                dir4: "./osaasto3/torstai/",
                dir5: "./osaasto3/perjantai/",
                dir6: "./osaasto3/lauantai/",
                dir7: "./osaasto3/sunnuntai/",
        ...
        $('#listBox6 option').each(function () {
            if (this.selected) {
                ...
                $("#btValmis2").click(function (e) {
                    ...
                    var path = "./osaasto3/tiistai/"
                    var selectedFileName = $("#listBox6 option:selected").text();
                    /*
                    var dt = new Date();
                    var time = dt.getHours() + ":" + dt.getMinutes();
                    */
                    // call osaasto3.php and post the data
                    $.ajax({
                        type: "POST",
                        url: "move-images3.php",
                        data: { pathDir: path, name: selectedFileName }
...
$(function () {
    ...
    $("#btDelete3").click(function (e) {
        ...
        if (r5 == true) {
            ...
            var path3 = "./osaasto3/keskiviikko/"
