<!DOCTYPE html>
<html>
<title>Osasto_5</title>

<head>
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
  <script src="osaasto5.js" type="text/javascript"></script>
...
if (isset($_POST["data"]) && !empty($_POST["data"])) {
  ...
  $destDirectory = "osaasto5/maanantai/";
  $file = $data2;
...
if (isset($_POST["data2"]) && !empty($_POST["data2"])) {
  ...
  $uri =  substr($data, strpos($data, ",") + 1);
  // create a filename for the new image
  $destDirectory = "osaasto5/tiistai/";
  $file = $data2;
  // decode the image data and save it to file
  file_put_contents($destDirectory . $file, base64_decode($uri));
}
...
if (isset($_POST["data3"]) && !empty($_POST["data3"])) {
  ...
  $uri =  substr($data, strpos($data, ",") + 1);
  // create a filename for the new image
  $destDirectory = "osaasto5/keskiviikko/";
  $file = $data2;
  // decode the image data and save it to file
  file_put_contents($destDirectory . $file, base64_decode($uri));
}
...
if (isset($_POST["data4"]) && !empty($_POST["data4"])) {
  ...
  $uri =  substr($data, strpos($data, ",") + 1);
  // create a filename for the new image
  $destDirectory = "osaasto5/torstai/";
  $file = $data2;
  // decode the image data and save it to file
  file_put_contents($destDirectory . $file, base64_decode($uri));
}
...
if (isset($_POST["data5"]) && !empty($_POST["data5"])) {
  ...
  $uri =  substr($data, strpos($data, ",") + 1);
  // create a filename for the new image
  $destDirectory = "osaasto5/perjantai/";
  $file = $data2;
  // decode the image data and save it to file
  file_put_contents($destDirectory . $file, base64_decode($uri));
}
...
if (isset($_POST["data6"]) && !empty($_POST["data6"])) {
  ...
  $uri =  substr($data, strpos($data, ",") + 1);
  // create a filename for the new image
  $destDirectory = "osaasto5/lauantai/";
  $file = $data2;
  // decode the image data and save it to file
  file_put_contents($destDirectory . $file, base64_decode($uri));
}
...
if (isset($_POST["data7"]) && !empty($_POST["data7"])) {
  ...
  $uri =  substr($data, strpos($data, ",") + 1);
  // create a filename for the new image
  $destDirectory = "osaasto5/sunnuntai/";
  $file = $data2;
  // decode the image data and save it to file
  file_put_contents($destDirectory . $file, base64_decode($uri));
}
