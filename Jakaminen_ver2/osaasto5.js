...
$(function () {
    ...
    $("#buttonSendMsg").click(function (e) {
        var dataset = { "valueClient5": document.getElementById('msgFromClient').value };
        $.ajax({
            url: 'message.php',
            type: 'POST',
            data: dataset,
...
setInterval(function (e) {
    $(function () {
        jQuery.get("messages/osaastot/receivemsg5.txt", function (data) {
        ...
        $.ajax({
            url: "messages/osaastot/receivemsg5.txt",
            dataType: "text",
...
$(function () {
    $("#updateButton").click(function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                dir1: "./osaasto5/maanantai/",
                dir2: "./osaasto5/tiistai/",
                dir3: "./osaasto5/keskiviikko/",
                dir4: "./osaasto5/torstai/",
                dir5: "./osaasto5/perjantai/",
                dir6: "./osaasto5/lauantai/",
                dir7: "./osaasto5/sunnuntai/",
        ...
        $('#listBox6 option').each(function () {
            if (this.selected) {
                ...
                $("#btValmis2").click(function (e) {
                    ...
                    var path = "./osaasto5/tiistai/"
                    var selectedFileName = $("#listBox6 option:selected").text();
                    /*
                    var dt = new Date();
                    var time = dt.getHours() + ":" + dt.getMinutes();
                    */
                    // call osaasto5.php and post the data
                    $.ajax({
                        type: "POST",
                        url: "move-images5.php",
                        data: { pathDir: path, name: selectedFileName }
...
$(function () {
    ...
    $("#btDelete3").click(function (e) {
        ...
        if (r5 == true) {
            ...
            var path3 = "./osaasto5/keskiviikko/"
